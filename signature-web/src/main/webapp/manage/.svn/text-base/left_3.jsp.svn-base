...
<div class="contentbox">
	...
	<script type="text/javascript">
		...
		f1.add(11,0,'所有签名','view_all_library.html?classId=0','','mainFrame');
		f1.add(12,0,'添加签名','view_add_library.html','','mainFrame');
		document.write(f1);
	 </script>
	</div>
   ...
   <script type="text/javascript">
		...
		f2.add(21,0,'所有分类','view_first_class.html?basis=2','','mainFrame');
		f2.add(22,0,'添加分类','view_add_class.html?basis=2','','mainFrame');
		document.write(f2);
   </script>
   </div> 
