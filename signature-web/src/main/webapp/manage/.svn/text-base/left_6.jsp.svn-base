...
<div class="contentbox">
	<div class="M_Yygl"><a href="javascript:Menushow(1);">用户管理</a></div>
	<div class="menubox" id="menu_1">
	<script type="text/javascript">
		f1 = new dTree('f1');
		f1.add(0,-1,'用户管理','','','mainFrame');
		f1.add(11,0,'所有用户','view_all_customer.html','','mainFrame');
		f1.add(12,0,'用户状态统计','view_customer_statistics.html','','mainFrame');
		document.write(f1);
	 </script>
	</div>
