...
<body>
 <form id="myForm" name="myForm"  method="post"   action="view_collect_library.html"> 
...
<div>   
       ...
       <tr bgcolor="#f8f8f8">       	 
          <td align="center" >
          	<input name="ro" type="radio" onclick="autoSet(this)" id="ro" 
          		 param0="<s:property value='#collect.classId'/>"  
                 param1="<s:property value='#collect.className'/>"
                 param2=""
                 param3=""
          	>
          </td>
		  <td align="left" style="padding-left:10px;" height="29">
          	<a class="linkblue02" href=""><s:property value="#collect.classId"/> </a>
          </td>
          <td align="left" style="padding-left:10px;" height="29">
			<s:property value="#collect.className"/>               
		  </td>
          <td align="left" style="padding-left:10px;" height="29">
    ...
    <div style="margin-right:15px;">
		...
		<s:include value="page.jsp">
			<s:param name="pageUrl" value="'view_collect_library.html?'"></s:param>
		</s:include> 
	</div>
</div>
